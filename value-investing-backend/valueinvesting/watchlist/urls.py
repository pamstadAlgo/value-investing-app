...
urlpatterns = [
    ...
    path('<int:pk>/add-stock/', views.WatchlistAddStockAPIView.as_view(), name='watchlist-add-stock'),
    path('<int:pk>/remove-stock/', views.WatchlistRemoveStockAPIView.as_view(), name='watchlist-remove-stock'),
